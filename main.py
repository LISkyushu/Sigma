...
### Param ###
simulation = 30 # Number of runs for each experiments
algorithm_list = ["syncmap", "word2vec", "sigma", "modmax"]
problem_list = ["IH", "HB", "IEH", "DIH", "DCH", "EC2EH", "EH2EC", "DCS"]
time_delay = 10
sequence_length = 600000# Total length of the sequence input generated by env
...
for algorithm in algorithm_list:
    ...
    for problem_index in problem_list:
        ...
        for i in tqdm(range(simulation)):
            ...
            if algorithm == "syncmap" or algorithm == "word2vec" or algorithm == "sigma":
